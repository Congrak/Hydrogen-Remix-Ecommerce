...
import {CartLineItems, CartSummary, CartActions} from '~/components/cartLineItem';
...
export default function Cart() {
  ...
  if (cart?.totalQuantity > 0)
    return (
      <div className="w-full max-w-6xl mx-auto pb-12 flex flex-row gridmd:grid-cols-2 md:items-start gap-8 md:gap-8 lg:gap-12">
        <div className="flex-grow w-full md:translate-y-4">
